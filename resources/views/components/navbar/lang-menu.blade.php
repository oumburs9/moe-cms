<li class="flex items-center order-2">
    ...
    <div id="lang"
        ...
        <ul class=" text-sm text-gray-700 dark:text-gray-200 space-y-2"
            ...
            <li>
                <a href="#"
                    class="block px-4 py-2 bg-mblue text-white dark:hover:bg-gray-600 dark:hover:text-white rounded-md">English</a>
            </li>
            <li>
                <a href="#"
                    class="block px-4 py-2 hover:bg-mblue dark:hover:bg-gray-600 hover:text-white rounded-md font-gotham">አማረኛ</a>
            </li>
        </ul>
    </div>
</li>